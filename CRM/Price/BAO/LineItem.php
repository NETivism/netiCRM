...
class CRM_Price_BAO_LineItem extends CRM_Price_DAO_LineItem {
   ...
   *
   * @return CRM_Price_BAO_LineItem|null
   */
  ...
  /**
   * Given a participant id/contribution id, return contribution/fee line items.
   *
   * @param int $entityId participant/contribution id
   * @param string $entity participant/contribution.
   *
...
WHERE     %2.id = %1";
  ...
  /**
   * This method will create the lineItem array required for processAmount method.
   *
   * @param int $fid price set field id
   * @param array $params reference to form values
   * @param array $fields reference to array of fields belonging to the price set used for particular event
   * @param array $values reference to the values array (this is lineItem array)
   *
   * @return void
   */
