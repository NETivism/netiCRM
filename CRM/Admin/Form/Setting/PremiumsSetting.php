...
class CRM_Admin_Form_Setting_PremiumsSetting extends CRM_Admin_Form_Setting {
  ...
  public function buildQuickForm() {
    ...
    $this->addElement(
      'select',
      'premiumIRCheckStatuses',
      ts('Check Status for Inventory Replenishment'),
      $statusOptions,
      $attrs
    );
    ...
    $this->addElement(
      'select',
      'premiumIRStatusChange',
      ts('Status Change After Inventory Replenishment'),
      $statusChangeOptions
    );
    ...
    $this->addElement(
      'select',
      'premiumIRManualCancel',
      ts('Manual Cancellation Inventory Replenishment'),
      $manualCancelOptions
    );
