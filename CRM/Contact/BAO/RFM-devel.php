...
class CRM_Contact_BAO_RFM {
   ...
   * @param mixed $rThreshold R threshold value, null means don't process
   *                          If negative, reverse comparison is used
   *                          If zero, include all data without threshold
   * @param mixed $fThreshold F threshold value, null means don't process
   *                          If negative, reverse comparison is used
   *                          If zero, include all data without threshold
   * @param mixed $mThreshold M threshold value, null means don't process
   *                          If negative, reverse comparison is used
   *                          If zero, include all data without threshold
   ...
   *
   * @param mixed $position Threshold position percentage or specific threshold value
   ...
   * @return mixed Calculated threshold value
   */
   ...
   */
  public function exportToCSV($filename = null, $download = true) {
    if (!$this->_tables['rfm']) {
      $r = $this->calcRFM();
    }
   ...
   */
  public static function defaultThresholds($rangeString, $thresholdType) {
