...
Class CRM_Campaign_BAO_Survey extends CRM_Campaign_DAO_Survey {
   ...
   */
  static
  function getSurveyList($all = FALSE) {
   ...
   */
  static
  function getSurveyActivityType() {
    require_once 'CRM/Core/OptionGroup.php';
    $activityTypes = array();
...
INNER JOIN  civicrm_activity_assignment activityAssignment ON ( activityAssignment.activity_id = activity.id )
   ...
   */
  static
  function getSurveyActivities($surveyId, $interviewerId = NULL, $statusIds = array()) {
    $activities = array();
    if (!$surveyId) {
      return $activities;
    }
...
INNER JOIN  civicrm_activity_assignment activityAssignment ON ( activityAssignment.activity_id = activity.id )
  ...
  static
  function buildPermissionLinks($surveyId) {
    $menuLinks = array();
    if (!$surveyId) {
      return $menuLinks;
    }
