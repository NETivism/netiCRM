        ...
        class CRM_Coupon_DAO_CouponEntity extends CRM_Core_DAO
{
   ...
   * @static
   */
  public static $_tableName = 'civicrm_coupon_entity';
  /**
  ...
  public $coupon_id;
  /**
   * Entity table like civicrm_event or civicrm_price_option.
   *
   * @var string
   */
  public $entity_table;
  /**
   * Entity id like event_id or price_option_id
   *
   * @var int unsigned
   */
  public $entity_id;
