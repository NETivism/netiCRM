...
class CRM_Utils_PDF_Label extends TCPDF {
  ...
  // Type of metric for labels.. Will help to calculate good values
  public $metric = 'mm';
  // Type of metric for the document
  public $metricDoc = 'mm';
  // Name of the font
  public $fontName = 'arialunicid0';
  public $countX = 0;
  public $countY = 0;
  ...
  function __construct($format, $unit = 'mm') {
    ...
    $oriantation = $tFormat['oriantation'] ? $tFormat['oriantation'] : 'P';
