...
class CRM_Contribute_DAO_SPGATEWAY extends CRM_Core_DAO {
   ...
   * @static
   */
  public static $_tableName = 'civicrm_contribution_spgateway';
  /**
  ...
  /**
   * Trade number generated by spgateway
   *
   * @var string
   */
  public $trade_no;
  /**
   * token_value for credit card agreement payment
   *
   * @var string
   */
  public $token_value;
  /**
   * token life for credit card agreement payment
   *
   * @var date
   */
  public $token_life;
  /**
   * The last four number of credit card.
   *
   * @var string
   */
  public $last_four;
  /**
   * Used date time of this track.
   *
   * @var date
   */
  public $expiry_date;
