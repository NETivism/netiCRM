  ...
  public function batchFinishCallback() {
    ...
    if (!empty($civicrm_batch)) {
      ...
      if ($zip->open($zipFile, ZipArchive::CREATE) == TRUE) {
        ...
        $errorFiles[] = CRM_Contribute_Import_Parser::errorFileName(CRM_Contribute_Import_Parser::NO_MATCH, $fileName);
        $errorFiles[] = CRM_Contribute_Import_Parser::errorFileName(CRM_Contribute_Import_Parser::UNPARSED_ADDRESS_WARNING, $fileName);
