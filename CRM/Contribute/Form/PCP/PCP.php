...
class CRM_Contribute_Form_PCP_PCP extends CRM_Core_Form {
  ...
  public function buildQuickForm() {
    if ($this->_action & CRM_Core_Action::DELETE) {
      ...
      $contribution_page = array(ts('- select -'));
      $additional_pages = CRM_Contribute_PseudoConstant::contributionPage();
      foreach ($additional_pages as $key => $value) {
        $contribution_page[$key] = $value;
      }
