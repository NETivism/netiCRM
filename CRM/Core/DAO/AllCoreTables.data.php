...
return [
  ...
  'CRM_Contribute_DAO_PremiumsCombinationProducts' => [
  ...
  'CRM_Standalone_OpenID_DAO_Nonce' => [
    'name' => 'Nonce',
    'class' => 'CRM_Standalone_OpenID_DAO_Nonce',
    'table' => 'civicrm_openid_nonces',
  ],
  'CRM_Standalone_OpenID_DAO_Associations' => [
    'name' => 'Associations',
  ...
  'CRM_Core_DAO_EntityFinancialTrxn' => [
  ...
  'CRM_Mailing_Event_DAO_Transactional' => [
    'name' => 'Transactional',
