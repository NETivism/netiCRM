...
return array(
  ...
  'CRM_Core_DAO_Currency' => array(
    'name' => 'Currency',
    'class' => 'CRM_Core_DAO_Currency',
  ...
  'CRM_Core_DAO_FinancialAccount' => array(
    'name' => 'FinancialAccount',
    'class' => 'CRM_Core_DAO_FinancialAccount',
    'table' => 'civicrm_financial_account',
  ) ,
  'CRM_Core_DAO_FinancialTrxn' => array(
    'name' => 'FinancialTrxn',
    'class' => 'CRM_Core_DAO_FinancialTrxn',
  ...
  'CRM_Core_DAO_PaymentProcessor' => array(
    'name' => 'PaymentProcessor',
    'class' => 'CRM_Core_DAO_PaymentProcessor',
    'table' => 'civicrm_payment_processor',
  ) ,
  'CRM_Core_DAO_PaymentProcessorType' => array(
    'name' => 'PaymentProcessorType',
    'class' => 'CRM_Core_DAO_PaymentProcessorType',
  ...
  'CRM_Core_DAO_Track' => array(
    'name' => 'Track',
    'class' => 'CRM_Core_DAO_Track',
    'table' => 'civicrm_track',
  ) ,
  ...
  'CRM_Mailing_DAO_Group' => array(
    'name' => 'Group',
    'class' => 'CRM_Mailing_DAO_Group',
  ...
  'CRM_Contribute_DAO_ContributionType' => array(
    'name' => 'ContributionType',
    'class' => 'CRM_Contribute_DAO_ContributionType',
    'table' => 'civicrm_contribution_type',
  ) ,
  'CRM_Contribute_DAO_LinePay' => array(
    'name' => 'LinePay',
  ...
  'CRM_Coupon_DAO_Coupon' => array(
    ...
    'table' => 'civicrm_coupon',
  ) ,
  'CRM_Coupon_DAO_CouponEntity' => array(
    'name' => 'CouponEntity',
    'class' => 'CRM_Coupon_DAO_CouponEntity',
    'table' => 'civicrm_coupon_entity',
  ) ,
  ...
  'CRM_Project_DAO_Project' => array(
    'name' => 'Project',
    'class' => 'CRM_Project_DAO_Project',
    'table' => 'civicrm_project',
  ) ,
  'CRM_Project_DAO_Task' => array(
    'name' => 'Task',
    'class' => 'CRM_Project_DAO_Task',
    'table' => 'civicrm_task',
  ) ,
  'CRM_Project_DAO_TaskStatus' => array(
    'name' => 'TaskStatus',
    'class' => 'CRM_Project_DAO_TaskStatus',
    'table' => 'civicrm_task_status',
  ) ,
  ...
  'CRM_Standalone_OpenID_DAO_Nonce' => array(
    'name' => 'Nonce',
    'class' => 'CRM_Standalone_OpenID_DAO_Nonce',
    'table' => 'civicrm_openid_nonces',
  ) ,
  'CRM_Standalone_OpenID_DAO_Associations' => array(
    'name' => 'Associations',
    'class' => 'CRM_Standalone_OpenID_DAO_Associations',
    'table' => 'civicrm_openid_associations',
  ) ,
  ...
  'CRM_Report_DAO_Instance' => array(
    'name' => 'Instance',
    'class' => 'CRM_Report_DAO_Instance',
  ...
  'CRM_Core_DAO_EntityFinancialTrxn' => array(
    'name' => 'EntityFinancialTrxn',
    'class' => 'CRM_Core_DAO_EntityFinancialTrxn',
  ...
  'CRM_Core_DAO_Preferences' => array(
    'name' => 'Preferences',
    'class' => 'CRM_Core_DAO_Preferences',
    'table' => 'civicrm_preferences',
  ) ,
  ...
  'CRM_Contribute_DAO_PCP' => array(
    'name' => 'PCP',
    'class' => 'CRM_Contribute_DAO_PCP',
    'table' => 'civicrm_pcp',
  ) ,
  ...
  'CRM_Activity_DAO_ActivityAssignment' => array(
    'name' => 'ActivityAssignment',
    'class' => 'CRM_Activity_DAO_ActivityAssignment',
    'table' => 'civicrm_activity_assignment',
  ) ,
  'CRM_Activity_DAO_ActivityTarget' => array(
    'name' => 'ActivityTarget',
    'class' => 'CRM_Activity_DAO_ActivityTarget',
  ...
  'CRM_Pledge_DAO_Payment' => array(
    'name' => 'Payment',
    'class' => 'CRM_Pledge_DAO_Payment',
