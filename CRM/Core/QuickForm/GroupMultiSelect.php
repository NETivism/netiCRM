...
class CRM_Core_QuickForm_GroupMultiSelect extends CRM_Core_QuickForm_NestedAdvMultiSelect {
  ...
  function toHtml() {
    ...
    if (strpos($this->_elementTemplate, '{unselected}') === FALSE) {
      ...
      $this->_attributesUnselected = ['name' => '__' . $selectName, 'ondblclick' => "{$this->_jsPrefix}{$this->_jsPostfix}(this.form.elements['__" . $selectName . "'], this.form.elements['_" . $selectName . "'], this.form.elements['" . $selectName . "'], 'add')"];
      ...
      $this->_attributesSelected = ['name' => '_' . $selectName, 'ondblclick' => "{$this->_jsPrefix}{$this->_jsPostfix}(this.form.elements['__" . $selectName . "'], this.form.elements['_" . $selectName . "'], this.form.elements['" . $selectName . "'], 'remove')"];
      ...
      $this->_attributesHidden = ['name' => $selectName, 'style' => 'overflow: hidden; visibility: hidden; width: 1px; height: 0;'];
