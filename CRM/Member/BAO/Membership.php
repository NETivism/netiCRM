...
INNER JOIN  civicrm_membership_type type ON ( type.id = membership.membership_type_id )
   ...
   */
  static
  function getContactMembership($contactID, $memType, $isTest, $membershipId = NULL) {
...
";
   ...
   */
  static
  function createRelatedMemberships(&$params, &$membership) {
...
";
   ...
   */
  static
  function getContactMembershipCount($contactID) {
