...
class CRM_Mailing_Event_DAO_Transactional extends CRM_Core_DAO {
  /**
   ...
   * @static
   */
  public static $_tableName = 'civicrm_mailing_event_transactional';
  /**
  ...
  /**
   * Foreign key to the activity for this mailing deliver record.
   *
   * @var int unsigned
   */
  public $activity_id;
   ...
   * class constructor
   *
   * @return civicrm_mailing_event_transactional
   */
