...
class CRM_Pledge_Selector_Search extends CRM_Core_Selector_Base {
   ...
   * @param string|null $additionalClause if the caller wants to further restrict the search (used in participations)
   * @param bool $single are we dealing only with one contact?
   * @param int|null $limit how many signers do we want returned
