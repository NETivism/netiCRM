...
VALUES 
 ...
 ('ALLPAY', '{ts escape="sql"}AllPay Credit Card{/ts}', NULL, 1, 0, '{ts escape="sql"}Merchant ID{/ts}', 'HashKey', 'HashIV', '', 'Payment_ALLPAY', '', '', '', NULL, '', '', '', NULL, 4, 1),
 ('ALLPAYX', '{ts escape="sql"}AllPay Non-Credit Card{/ts}', NULL, 1, 0, '{ts escape="sql"}Merchant ID{/ts}', 'HashKey', 'HashIV', '', 'Payment_ALLPAY', '', '', NULL, NULL, '', '', NULL, NULL, 4, 0),
...
('BACKER', '{ts escape="sql"}Backer Founder{/ts}', NULL, 1, 0, NULL, 'Secret Key', NULL, NULL, 'Payment_Backer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 0);
