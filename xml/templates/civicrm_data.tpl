...
-- Activity Types for case activities
  ...
  (@option_group_id_pi, '{ts escape="sql"}Apple Pay Front{/ts}',  23, 'ApplePayFront', NULL, 0, NULL, 17, NULL, 0, 1, 1, NULL, NULL),
  ...
  (@option_group_id_pcp, '{ts escape="sql"}Draft{/ts}',          0, 'Draft'         , NULL, 0, NULL, 0, NULL, 0, 1, 1, NULL, NULL),
...
-- report templates
  ...
  (@option_group_id_we, 'TinyMCE'    , 1, NULL, NULL, 0, NULL, 1, NULL, 0, 1, 0, NULL, NULL),
  (@option_group_id_we, 'CKEditor4' , 2, NULL, NULL, 0, NULL, 2, NULL, 0, 1, 1, NULL, NULL),
  (@option_group_id_we, 'CKEditor5' , 4, NULL, NULL, 0, NULL, 4, NULL, 0, 1, 1, NULL, NULL),
...
VALUES (@drgid, 'civicrm_contact', 'organization_name', 10),
       (@drgid, 'civicrm_contact', 'sic_code',          8),
       (@drgid, 'civicrm_email'  , 'email',             5);
...
INSERT INTO civicrm_uf_field
       ...
       (48,  11,           'current_employer',      1,           0,           3,      'User and User Admin Only',  0,           0,             NULL,             '{ts escape="sql"}Current Employer{/ts}',         		'Contact',     NULL,  NULL),
 	     (49,  11,           'phone' 				 ,0  	      ,0 			,2 	,'User and User Admin Only' ,0 		 	 ,0 			,1 				  ,'{ts escape="sql"}Home Mobile{/ts}' 					,'Contact' 	  ,NULL, 2 ),
