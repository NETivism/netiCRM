...
VALUES 
 ...
 ('TapPay', '{ts escape="sql"}TapPay Payment{/ts}', NULL, 1, 0, 'Merchant ID', '{ts escape="sql"}Partner Key{/ts}', NULL, NULL,  'Payment_TapPay', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,  4, NULL);
