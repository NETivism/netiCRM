...
VALUES
  ...
  (@option_group_id_languages, 1, 1, 'zh_TW', 'zh', 'Chinese (Taiwan)', @counter := @counter + 1),
  ...
  (@option_group_id_languages, 0, 1, 'en_US', 'en', 'English (United States)', @counter := @counter + 1),
  ...
  (@option_group_id_languages, 0, 0, 'nb_NO', 'nb', 'Norwegian Bokmål', @counter := @counter + 1),
