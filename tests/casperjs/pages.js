...
var url = [
  ...
  {title:'Users', url:'admin/user/user'},
  ...
  {title:'', url:'civicrm/pledge?reset=1'},
  {title:'', url:'civicrm/pledge/add?reset=1&action=add&context=standalone'},
  {title:'', url:'civicrm/pledge/search?reset=1'},
