...
var vars = {
    ...
    amount: '101',
    NewebPay_title: '藍新金流Newebpay第三方支付金流平台',
};
...
test.describe.serial('SPGATEWAY', () => {
    ...
    test('Payment', async () => {
        ...
        await test.step('Contribution page', async () => {
            ...
            /* choose "Recurring contributions - monthly" */
            element = '#CIVICRM_QFID_1_8';
            ...
            /* choose No receipt required */
            element = '#CIVICRM_QFID_0_10';
            await utils.findElement(page, element);
            await utils.clickElement(page, page.locator(element));
            await expect(page.locator(element)).toBeChecked();
        ...
        await test.step('NewebPay Payment Page Check', async () => {

            /* Step 3: NewebPay Payment Page Check */
            await page.waitForURL('https://ccore.newebpay.com/MPG/period');
            await expect(page).toHaveURL('https://ccore.newebpay.com/MPG/period');
