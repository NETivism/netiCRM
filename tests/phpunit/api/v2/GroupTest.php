...
class api_v2_GroupTest extends CiviUnitTestCase {
  ...
  public function testGetGroupEmptyParams() {
    $params = '';
  ...
  public function testgroupdeleteNonArrayParams() {
    $params = 'TestNotArray';
