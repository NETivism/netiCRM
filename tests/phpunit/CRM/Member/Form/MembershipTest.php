...
class CRM_Member_Form_MembershipTest extends CiviUnitTestCase {
  ...
  public function testFormRuleEmptyContact() {
    ...
    $this->assertTrue(
      array_key_exists('membership_type_id', $rc),
      'In line ' . __LINE__
    );
    $this->assertTrue(
      array_key_exists('join_date', $rc),
      'In line ' . __LINE__
    );
  }
  ...
  public function testFormRuleRollingEarlyStart() {
    ...
    $obj    = new CRM_Member_Form_Membership();
    $rc = call_user_func(
      ['CRM_Member_Form_Membership','formRule'],
      $params,
      $files,
      $obj
    );
    ...
    $this->assertTrue(
      array_key_exists('start_date', $rc),
      'In line ' . __LINE__
    );
  }
  ...
  public function testFormRuleRollingJoin1MonthFromNow() {
    ...
    $this->assertTrue(
      array_key_exists('_qf_default', $rc),
      'In line ' . __LINE__
    );
  }
