...
class CRM_Member_BAO_MembershipTest extends CiviUnitTestCase {
  ...
  public function testCreate() {
    ...
    $membershipId = $this->assertDBNotNull(
    ...
    $membershipTypeId = $this->assertDBNotNull(
      'CRM_Member_BAO_Membership',
      $contactId,
      'membership_type_id',
      'contact_id',
  ...
  public function testGetValues() {
    ...
    $membershipId1 = $this->assertDBNotNull(
      'CRM_Member_BAO_Membership',
      $contactId,
      'id',
      'contact_id',
    ...
    $membershipId2 = $this->assertDBNotNull(
      'CRM_Member_BAO_Membership',
      'source123',
      'id',
      'source',
  ...
  public function testDeleteMembership() {
    ...
    $membershipId = $this->assertDBNull(
      'CRM_Member_BAO_Membership',
      $contactId,
      'id',
      'contact_id',
      'Database check for deleted membership.'
    );
    Contact::delete($contactId);
  }
