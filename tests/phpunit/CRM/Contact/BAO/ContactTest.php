...
class CRM_Contact_BAO_ContactTest extends CiviUnitTestCase {
  ...
  public function testAddWithAll() {
    ...
    $this->assertEquals(
      CRM_Utils_Date::processDate($params['birth_date']),
      $contact->birth_date,
      'Check for birth_date creation.'
    );
    $this->assertEquals(
      CRM_Utils_Date::processDate($params['deceased_date']),
    ...
    $updateParams    =  [ 'contact_type'          => 'Individual',
                               'first_name'            => 'Jane',
                               'middle_name'           => 'abc',
                               'last_name'             => 'Doe',
                               'prefix_id'             => 2,
    ...
    $this->assertEquals(
      $updateParams['external_identifier'],
      $contact->external_identifier,
      'Check for external_identifier creation.'
    );
    $this->assertEquals(
      $updateParams['last_name'] . ', ' .$updateParams['first_name'],
      $contact->sort_name,
      'Check for sort_name creation.'
    );
    $this->assertEquals(
      $updateParams['preferred_mail_format'],
      $contact->preferred_mail_format,
      'Check for preferred_mail_format creation.'
    );
    ...
    require_once 'CRM/Utils/Date.php';
    $this->assertEquals(
      CRM_Utils_Date::processDate($updateParams['birth_date']),
      $contact->birth_date,
      'Check for birth_date creation.'
    );
    $this->assertEquals(
      CRM_Utils_Date::processDate($updateParams['deceased_date']),
      $contact->deceased_date,
      'Check for deceased_date creation.'
    );
    require_once 'CRM/Core/BAO/CustomOption.php';
  ...
  public function testAddWithAllContactTypes() {
    ...
    $params        = [ 'household_name' => $householdName,
  ...
  public function testCreateWithAll() {
    ...
    $searchParams  = [ 'contact_id'             => $contactId,
                            'location_type_id'       => 1,
                            'is_primary'             => 1 ];
    $compareParams = [ 'street_address'         => CRM_Utils_Array::value('street_address', $params['address'][1]),
                            'supplemental_address_1' => CRM_Utils_Array::value(
                              'supplemental_address_1',
                              $params['address'][1]
                            ),
                            'supplemental_address_2' => CRM_Utils_Array::value(
                            ...
                            'state_province_id'      => CRM_Utils_Array::value(
                              'state_province_id',
                              $params['address'][1]
                            ),
    ...
    //Now check DB for IM
    $compareParams = [ 'name'                   => CRM_Utils_Array::value('name', $params['im'][1]),
    ...
    $searchParams  = [ 'entity_id'    => $contactId,
    ...
    $updateParams['address'][1] =  [ 'location_type_id'                               => 1,
                                          'is_primary'                                     => 1,
    ...
    $searchParams  = [ 'contact_id'             => $contactId,
                            'location_type_id'       => 1,
                            'is_primary'             => 1 ];
    $compareParams = [ 'street_address'         => 'Oberoi Garden',
                            'supplemental_address_1' => 'A-wing:3037',
                            'supplemental_address_2' => 'Andhery',
                            'city'                   => 'Mumbai',
                            'postal_code'            => '12345',
  ...
  public function testResolveDefaults() {
    ...
    $this->assertEquals(
      CRM_Core_PseudoConstant::stateProvince($params['address'][1]['state_province_id']),
      $params['address'][1]['state_province'],
      'Check for state province.'
    );
    $this->assertEquals(
      CRM_Core_PseudoConstant::country($params['address'][1]['country_id']),
  ...
  public function testDeleteContact() {
    ...
    $this->assertDBNull(
      ...
      'id',
      'openid',
      'Database check, openId deleted successfully.'
    );
    ...
    $this->assertEquals(
      CRM_Utils_Array::value("custom_".$customField->id, $values),
      '',
    ...
    $this->assertDBNull(
      ...
      'id',
      'sort_name',
      'Database check, contact deleted successfully.'
    );
    $this->quickCleanup([ 'civicrm_contact', 'civicrm_note' ]);
  }
  ...
  public function testCreateProfileContact() {
    ...
    $fields['organization_name'] =    ['name' => 'organization_name',
                                            'where' => 'civicrm_organization.organization_name',
                                            'title' => 'Current Employer'];
    //get the common params
    $contactParams = $this->contactParams();
    $unsetParams = [ 'location', 'gender_id', 'prefix_id', 'suffix_id', 'privacy' ];
    ...
    $this->assertDBCompareValue(
      ...
      'user_unique_id',
      'id',
      $profileParams['user_unique_id'],
      'Check for user_unique_id creation.'
    );
    ...
    $searchParams  = [ 'contact_id'             => $contactId,
                            'location_type_id'       => 1,
                            'is_primary'             => 1 ];
    $compareParams = [ 'street_address'         => CRM_Utils_Array::value('street_address-Primary', $profileParams),
    ...
    //Now check DB for IM
    $compareParams = [ 'name'                   => CRM_Utils_Array::value('im-Primary', $profileParams),
    ...
    $searchParams  = [ 'contact_id'             => $contactId,
                            'location_type_id'       => 1,
                            'is_primary'             => 1 ];
    $compareParams = [ 'street_address'         => CRM_Utils_Array::value('street_address-Primary', $updatePfParams),
    ...
    //Now check DB for IM
    $compareParams = [ 'name'                   => CRM_Utils_Array::value('im-Primary', $updatePfParams),
  ...
  public function testGetContactDetails() {
    ...
    $compareParams = [ $params['first_name'] . ' ' .$params['last_name'],
  ...
  public function testMatchContactOnEmail() {
    ...
    $match = CRM_Contact_BAO_Contact::matchContactOnEmail(
      CRM_Utils_Array::value('email', $params['email'][1]),
      'Individual'
    );
