 ...
 *   API result array
 */
function civicrm_api3_open_id_create($params) {
 ...
 */
function _civicrm_api3_open_id_create_spec(&$params) {
 ...
 *   API result array
 */
function civicrm_api3_open_id_delete($params) {
 ...
 *   API result array
 */
function civicrm_api3_open_id_get($params) {
