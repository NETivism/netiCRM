...
function civicrm_api3_profile_get($params) {
  ...
  if ($isContactActivityProfile) {
    ...
    $errors = CRM_Profile_Form::validateContactActivityProfile(
      $params['activity_id'],
      $params['contact_id'],
      $params['profile_id']
    );
...
function civicrm_api3_profile_set($params) {
  ...
  if (isset($profileFields['group'])) {
    CRM_Contact_BAO_GroupContact::create(
      $groups,
      $params['contact_id'],
      FALSE,
      'Admin'
...
function civicrm_api3_profile_apply($params) {
  ...
  list($data, $contactDetails) = CRM_Contact_BAO_Contact::formatProfileContactParams(
    $params,
    $profileFields,
