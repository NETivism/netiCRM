...
<div id="help">
    ...
    {if $noProfile} 
        ...
        {capture assign=tsProfile}{ts}Profile{/ts}{/capture}
        {ts 1=$crmURL 2=$tsProfile}No Profile(s) have been configured / enabled for your site. You need to first configure <a href="%1"><strong>&raquo; %2 </strong></a>(s).{/ts} {docURL page="Profiles Admin"}
        </div>
    {else}
