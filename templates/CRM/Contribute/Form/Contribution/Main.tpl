...
<div class="crm-block crm-contribution-main-form-block">
  ...
  <div class="progress-block">
    <div class="progress-amount">
      ...
      <div class="progress-amount-goal">{if $achievement.type == "amount"}{ts}Goal Amount{/ts} {$achievement.goal|crmMoney}{else}{ts}Goal People{/ts} {$achievement.goal}{ts}People{/ts}{/if}</div>
    </div>
