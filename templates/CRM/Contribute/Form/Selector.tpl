...
<table class="selector">
  ...
  <tr id="rowid{$row.contribution_id}" class="{cycle values="odd-row,even-row"}{if $row.cancel_date && $row.contribution_status_id neq '1'} disabled{/if}{if $row.contribution_status_id} contribution-status-{$row.contribution_status_id}{/if} crm-contribution_{$row.contribution_id}">
    {if !$single }
