  ...
  <table class="form-layout-compressed">
        <tr>
          ...
          <td class="html-adjust with-help-link">{$form.uploadFile.html}
            <a class="help-link new-window-link" href="{if isset($config->docURLBase)}{$config->docURLBase}{/if}Prepare+Files+for+Importing+Contributions" target="_blank">{ts}Imported tutorial and example file{/ts}</a>
