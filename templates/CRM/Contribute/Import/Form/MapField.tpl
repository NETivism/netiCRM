...
<div class="crm-block crm-form-block crm-contribution-import-form-block id="upload-file">
 ...
 <div id="help">
    ...
    <p>{ts}When updating an existing contribution, the Contribution IDs, Transaction ID, and Invoice ID can be any one of these three fields as the value corresponding to the existing contribution.{/ts}</p>
</div>
