...
if (userAgent && referrer) {
  ...
  var hasCookiePermission = document.cookie.indexOf("safariCookieFix=1") != -1;
  ...
  if (isSafari && hasForm) {
    ...
    window.setTimeout(function(){
      ...
      var stillNoCookie = document.cookie.indexOf("safariCookieFix=1") == -1;
      if (stillNoCookie) {
    ...
    if (!hasCookiePermission) {
      var redirect = location.origin + "/civicrm/safari-fix?ref=" + referrer;
