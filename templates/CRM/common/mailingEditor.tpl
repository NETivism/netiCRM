...
{js src=packages/poshytip/src/jquery.poshytip.js d7_group=999 d7_weight=997}{/js}
...
{js src=packages/x-editable/dist/jquery-editable/js/jquery-editable-poshytip.js d7_group=999 d7_weight=997}{/js}
...
{/if}
{js src=packages/x-editable/dist/inputs-ext/quill/lib/quill.min.js d7_group=999 d7_weight=997}{/js}
{js src=packages/x-editable/dist/inputs-ext/quill/lib/quill.placeholder.js d7_group=999 d7_weight=997}{/js}
{js src=packages/x-editable/dist/inputs-ext/quill/quill.js d7_group=999 d7_weight=997}{/js}


<!-- pickr -->
<link rel="stylesheet" href="{$config->resourceBase}packages/pickr/dist/themes/nano.min.css?v{$config->ver}"/>
{js src=packages/pickr/dist/pickr.min.js d7_group=999 d7_weight=997}{/js}

<!-- Magnific Popup -->
<link rel="stylesheet" href="{$config->resourceBase}packages/Magnific-Popup/dist/magnific-popup.css?v{$config->ver}">
{js src=packages/Magnific-Popup/dist/jquery.magnific-popup.js d7_group=999 d7_weight=997}{/js}
...
{/literal}
{js src=packages/mailingEditor/mailingEditor.js d7_group=999 d7_weight=998}{/js}
{literal}
<script type="text/javascript">
(function ($) {
	$(function() {
