...
<fieldset><legend>{if $action eq 1}{ts}New Mailing Component{/ts}{else}{ts}Edit Mailing Component{/ts}{/if}</legend>
  <table class="form-layout">
    ...
    <tr class="crm-mailing-component-form-block-body_text"><td class="label">{$form.body_text.label}<span class="marker"> *</span></td><td>{$form.body_text.html}</td>
    <tr class="crm-mailing-component-form-block-body_html"><td class="label">{$form.body_html.label}<span class="marker"> *</span></td><td>{$form.body_html.html}</td>
