        ...
        <table class="form-layout-compressed">
            ...
            {foreach from=$elements item=element}
                <tr class="crm-contact-custom-search-form-row-{$element}">
                    ...
                    {if $is_date eq '_date'}
                        {capture assign=element_from}{$element}_from{/capture}
                        {capture assign=element_to}{$element}_to{/capture}
                        <td class="label">{$form.$element_from.label}</td>
                        <td>
                          {include file="CRM/common/jcalendar.tpl" elementName="`$element`_from"} <span>{$form.$element_to.label}</span>
                          {include file="CRM/common/jcalendar.tpl" elementName="`$element`_to"}
                        </td>
                    {else}
