...
<div class="crm-block crm-content-block crm-grant-view-block">
    <div class="crm-submit-buttons">
        {if call_user_func(array('CRM_Core_Permission','check'), 'edit grants')}
            ...
            {/if}
            <a class="button" href="{crmURL p='civicrm/contact/view/grant' q=$urlParams}" accesskey="e"><span><div class="zmdi zmdi-edit"></div> {ts}Edit{/ts}</span></a>
        {/if}
        {if call_user_func(array('CRM_Core_Permission','check'), 'delete in CiviGrant')}
            ...
            {/if}
            <a class="button" href="{crmURL p='civicrm/contact/view/grant' q=$urlParams}"><span><div class="zmdi zmdi-delete"></div>{ts}Delete{/ts}</span></a>
        {/if}
