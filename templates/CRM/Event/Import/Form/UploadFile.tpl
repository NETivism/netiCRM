   ...
   <table class="form-layout">	
        <tr class="crm-event-import-uploadfile-form-block-uploadFile">
            ...
            <td class="html-adjust with-help-link">{$form.uploadFile.html}
              <a class="help-link new-window-link" href="{if isset($config->docURLBase)}{$config->docURLBase}{/if}Prepare+Files+for+Importing+Events" target="_blank">{ts}Imported tutorial and example file{/ts}</a>
