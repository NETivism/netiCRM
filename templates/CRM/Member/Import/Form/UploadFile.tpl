      ...
      <div id="upload-file" class="form-item">
       <tr class="crm-member-import-uploadfile-from-block-uploadFile">
          ...
          <td class="html-adjust with-help-link">{$form.uploadFile.html}
            <a class="help-link new-window-link" href="{if isset($config->docURLBase)}{$config->docURLBase}{/if}Prepare+Files+for+Importing+Members" target="_blank">{ts}Imported tutorial and example file{/ts}</a>
