...
function resizeTree()
{
	...
	treeDiv.style.width = String(document.documentElement.offsetWidth) + 'px';
	treeDiv.style.height = String(document.documentElement.clientHeight - 27) + 'px';
}

window.onresize = resizeTree;
setInterval(resizeTreeIfNeeded, 200);
var scrHeight = document.documentElement.clientHeight;
var scrWidth = document.documentElement.clientWidth;
function resizeTreeIfNeeded()
{
	if(scrHeight != document.documentElement.clientHeight || 
