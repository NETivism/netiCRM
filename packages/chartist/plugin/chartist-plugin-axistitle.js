          ...
          return function ctAxisTitle(chart) {
              ...
              chart.on('created', function (data) {
                  ...
                  console.log(options);
                      ...
                      if(options.axisX.position === 'end') {
                        xPos = data.axisX.axisLength + data.options.axisY.offset + data.options.chartPadding.left;
                      }
                      else{
                  ...
                  if (options.axisY.axisTitle && data.axisY) {
                      ...
                      var transform = 'rotate(' + (options.axisY.flipTitle ? 90 : 0) + ', ' + xPos + ', ' + yPos + ')';
