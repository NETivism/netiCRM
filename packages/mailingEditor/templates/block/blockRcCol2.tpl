{*
Template name: blockRcCol2.tpl

===================================
Class name mapping of nmeEditor and mailchimp:
===================================
nmeb-rc-col-2 nmeb | mcnTextBlock
...
<textarea class="nme-tpl" data-template-level="block" data-template-name="rc-col-2">
{* Template Content: BEGIN *}
<table data-id="[nmeBlockID]" data-type="[nmeBlockType]" border="0" cellpadding="0" cellspacing="0" width="100%" class="nmeb-rc-col-2 nmeb" style="min-width: 100%;">
