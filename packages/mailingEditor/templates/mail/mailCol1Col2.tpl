<textarea class="nme-tpl" data-template-level="mail" data-template-name="col-1-col-2">
{* Template Content: BEGIN *}
<center>
  <!-- Body Table: BEGIN -->
  <table class="nme-body-table" align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" data-settings-target="page">
    <tbody>
      <tr>
        <!-- Body Cell: BEGIN -->
