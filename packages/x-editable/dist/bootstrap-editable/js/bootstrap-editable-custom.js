        ...
        init: function () {
            ...
            if(this.options.toggle !== 'manual') {
                ...
                var options = this.options,
                    type = options.type;
                if (type == 'xeimce') {
                    this.$element.wrap("<div class='editable-imce editable-file'></div>");
                }
                ...
                this.$element.on(this.options.toggle + '.editable', $.proxy(function(e){
                    ...
                    /* Custom */
                    if (type == 'xeimce') {
                        window.imceCurrentTarget = this.$element.closest('.editable-file');
                        var win = window.open('index.php?q=imce&app=editable|sendto@EditableIMCE', 'editable_imce', 'width=640, height=480');
                    }
                    else {
