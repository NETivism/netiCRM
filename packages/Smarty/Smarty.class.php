    ...
    function append($tpl_var, $value=null, $merge=false)
    {
        if (is_array($tpl_var)) {
            ...
            foreach ($tpl_var as $_key => $_val) {
                if ($_key != '') {
                    if(!(isset($this->_tpl_vars[$_key]) && is_array($this->_tpl_vars[$_key]))) {
    ...
    function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false)
    {
        ...
        if (!$this->debugging && $this->debugging_ctrl == 'URL') {
            ...
            if (strstr($_query_string, $this->_smarty_debug_id)) {
                ...
                $this->debugging = (bool)($this->request_use_auto_globals ? ($_COOKIE['SMARTY_DEBUG'] ?? false) : ($GLOBALS['HTTP_COOKIE_VARS']['SMARTY_DEBUG'] ?? false));
            }
        }
            ...
            if (smarty_core_read_cache_file($_params, $this)) {
                ...
                if ($display) {
                    ...
                    if ($this->cache_modified_check) {
                        ...
                        $_last_modified_date = isset($_server_vars['HTTP_IF_MODIFIED_SINCE']) ? substr($_server_vars['HTTP_IF_MODIFIED_SINCE'], 0, strpos($_server_vars['HTTP_IF_MODIFIED_SINCE'], 'GMT') + 3) : '';
